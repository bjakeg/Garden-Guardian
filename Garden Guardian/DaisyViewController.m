...
@interface DaisyViewController ()

@end

@implementation DaisyViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    self.view.backgroundColor = [UIColor whiteColor];
    [self setTitle:@"Daisies"];
    
    UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(self.view.frame.size.width/2 - 200/2, 70, 200, 200)];
    [imageView setImage:[UIImage imageNamed:@"Daisy.jpg"]];
    ...
    plantingInfo.text = @"Plant 1 inch apart\nSoil > 60F";
    ...
    harvestingInfo.text = @"Prune excessive leaves\nHarvest 2 weeks after bulb stage";
